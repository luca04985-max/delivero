                    ...
                    try {
                        ...
                        try {
                            ...
                            if (orderData?.delivery_latitude && orderData?.delivery_longitude) {
                                ...
                                console.log('📍 [RiderLocationSender] Calculated improved ETA:', eta_minutes, 'minutes');
                            } else {
                                console.warn('📍 [RiderLocationSender] No delivery coordinates available for ETA calculation');
                            }
                        } catch (orderError) {
                            console.warn('📍 [RiderLocationSender] Failed to fetch order data for ETA:', orderError.message);
                        }
