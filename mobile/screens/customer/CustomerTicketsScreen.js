...
const styles = StyleSheet.create({
  header: { backgroundColor: '#FF6B00', padding: 20, paddingTop: 50 },
  title: { color: '#fff', fontSize: 22, fontWeight: 'bold' },
  loadingContainer: { flex: 1, justifyContent: 'center', alignItems: 'center' },
  loadingText: { fontSize: 16, color: '#666' },
  emptyText: { textAlign: 'center', marginTop: 50, fontSize: 16, color: '#666' },
  fab: { position: 'absolute', bottom: 30, right: 30, backgroundColor: '#FF6B00', width: 60, height: 60, borderRadius: 30, justifyContent: 'center', alignItems: 'center', elevation: 8 },
  ...
  createButton: { backgroundColor: '#FF6B00' },
  cancelButtonText: { color: '#333', textAlign: 'center', fontWeight: 'bold' },
  createButtonText: { color: '#fff', textAlign: 'center', fontWeight: 'bold' },
  ticketCard: { backgroundColor: '#fff', padding: 15, borderRadius: 10, marginBottom: 10, elevation: 2, borderLeftWidth: 4, borderLeftColor: '#FF6B00' },
